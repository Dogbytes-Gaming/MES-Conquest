...
namespace MesConquest
{
	public class MESApi
	{
		...
		public const long _mesModId = 1521905890;
		public Action<Vector3D, string, double, int, int, int> _addKnownPlayerLocation;
		public Func<Vector3D, string, string, bool, bool, List<string>, string, MatrixD, Vector3D, bool, long, bool> _apiSpawnRequest;
		public Action<bool, Action<IMyRemoteControl, string, string, IMyEntity, Vector3D>> _behaviorTriggerActivationWatcher; //TODO: Complete This
		public Action<string, MatrixD, long, ulong> _chatCommand;
		public Action<Vector3D, string, double, bool> _changeKnownPlayerLocationSize;
		public Func<string, string> _convertRandomNamePatterns;
		public Func<List<string>, MatrixD, Vector3, bool, string, string, bool> _customSpawnRequest;
		public Func<IMyCubeGrid, Vector3D> _getDespawnCoords;
		public Func<List<string>> _getSpawnGroupBlackList;
		public Action<string, List<string>> _getSpawnGroupsByType;
		public Action<long, string, List<MyTuple<IMyRadioAntenna, DateTime>>> _getPlayerInhibitorData;
		public Func<List<string>> _getNpcNameBlackList;
		public Func<Vector3D, bool, string, bool> _isPositionInKnownPlayerLocation;
		public Func<IMyCubeGrid, Vector3D> _getNpcStartCoordinates;
		public Func<IMyCubeGrid, Vector3D> _getNpcEndCoordinates;
		public Action<bool, string, Func<IMyRemoteControl, string, IMyEntity, Vector3D, bool>> _registerBehaviorCustomTrigger;
		public Action<bool, Action<IMyRemoteControl, IMyCubeGrid>> _registerCompromisedRemoteWatcher;
		public Action<bool, string, Func<string, string, string, Vector3D, bool>> _registerCustomSpawnCondition;
		public Func<IMyCubeGrid, Action<IMyCubeGrid, string>, bool> _registerDespawnWatcher;
		public Action<IMyRemoteControl, string> _registerRemoteControlCode;
		public Action<Action<IMyCubeGrid>, bool> _registerSuccessfulSpawnAction;
		public Action<Vector3D, string, bool> _removeKnownPlayerLocation;
		public Action<IMyCubeGrid, bool> _setCargoShipOverride;
		public Action<bool> _setCombatPhase;
		public Func<IMyCubeGrid, bool, bool> _setSpawnerIgnoreForDespawn;
		public Action<string, bool, Vector3D?> _setZoneEnabled;
		public Func<Vector3D, List<string>, bool> _spawnBossEncounter;
		public Func<Vector3D, List<string>, bool> _spawnPlanetaryCargoShip;
		public Func<Vector3D, List<string>, bool> _spawnPlanetaryInstallation;
		public Func<Vector3D, List<string>, bool> _spawnRandomEncounter;
		public Func<Vector3D, List<string>, bool> _spawnSpaceCargoShip;
		public Action<string, bool> _toggleSpawnGroupEnabled;
		public Action<bool, string, Action<object[]>> _registerCustomAction;
